...
return <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sidebar" style={{width: "280px"}}>
    <a href="/" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      ...
      <span className="fs-4">VishalMedia</span>
    </a>
    <hr/>
    <ul className="nav nav-pills flex-column mb-auto">
      <li className="nav-item" onClick={()=>setSelectedPost("Home")}>
        <a href="#" className={`nav-link text-white ${SelectedPost==='Home' && 'active'}`} aria-current="page">
          <svg className="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlinkHref="#home"></use></svg>
          Home
        </a>
      </li>
      <li onClick={()=>setSelectedPost("CreatePost")}>
        <a href="#" className={`nav-link text-white ${SelectedPost==='CreatePost' && 'active'}`} >
